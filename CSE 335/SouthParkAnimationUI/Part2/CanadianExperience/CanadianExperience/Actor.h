...
public:
	...
	*/
	...
	/* \brief Get the position channel 
	* \return CAnimChannelPoint our position channel */
	CAnimChannelPoint* GetPositionChannel() { return &mPositionChannel; }
...
private:
	...
	/// The animation channel for animating the position of this drawable (point)
